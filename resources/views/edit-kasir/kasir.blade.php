...
@section('content')
    ...
    <div class="mx-auto max-w-full px-3 py-3 sm:px-4 lg:px-6">
        <div class="row">
            <div class="col-md-6">
                @include('edit-kasir.kasir.cart')
            </div>
            <div class="col-md-6 product">
                @include('edit-kasir.kasir.product')
            </div>
        </div>
    </div>
@endsection
...
@section('js')
    ...
    <script>
        ...
        document.addEventListener('productAdded', function() {
            ...
            const id = urlParts[urlParts.length - 1]; // ambil bagian terakhir dari URL

            fetch(`/transaksi/refresh/${id}`)
