...
<div class="card mx-auto overflow-hidden" id="cartContainer">
    <div class="card-body d-flex flex-column h-100">
        ...
        <div class="table-container">
            ...
            @include('edit-kasir.kasir.cart-items')
            {{--  --}}
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="paymentForm" action="{{ route('transaksi.update') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="transaksi_id" id="hiddenId">
                    <div class="mb-3">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('deleteAllButton').addEventListener('click', function() {
            if (confirm('Apakah Anda yakin ingin menghapus semua item dari keranjang?')) {
                ...
                const url = `{{ route('detail.transaksi.destroyAll', ':id') }}`.replace(':id', id);
