        ...
        return new Promise(function(resolve) {
            ...
            JsBarcode(canvas, barcode, {
                ...
                valid: function(valid) {
                    if (!valid) {
                        console.error('Barcode tidak valid untuk EAN13:', barcode);
                        alert('Barcode tidak valid untuk format EAN13.\nPastikan barcode terdiri dari 13 digit angka dan memiliki checksum yang benar.');
                    }
                }
            });
            setTimeout(function() {
                if (!canvas.toDataURL) {
                    reject('Gagal membuat barcode image.');
                    return;
                }
