                        ...
                        <form id="filterForm" method="GET">
                            <div class="row g-3">
                                ...
                                <div class="col-md-3 d-flex align-items-center justify-content-around">
                                    ...
                                    <a href="{{ route('laporan.transaksi.pembelian') }}"
            ...
            <div class="col-12 mb-2 ">
                <div class="card">
                    <div class="d-flex justify-content-between align-items-center p-3">
                        <h5 class="mb-0">Daftar Laporan Pembelian</h5>
                    </div>
                    <div class="container">
...
@section('js')
    ...
    <script>
        document.getElementById('printPdfBtn').addEventListener('click', function() {
            ...
            const url = `{{ route('transaksi.pdf.pembelian') }}?start_date=${startDate}&end_date=${endDate}`;
